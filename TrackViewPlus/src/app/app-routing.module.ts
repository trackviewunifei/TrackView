...
import { DashClientesEventosComponent } from './dash-clientes-eventos/dash-clientes-eventos.component';
import { DashEstruturaPaginasComponent } from './dash-estrutura-paginas/dash-estrutura-paginas.component';
...
const routes: Routes = [
  ...
  {path: 'dashClientesEventos', component:DashClientesEventosComponent},
  {path: 'dashEstruturaPaginas', component:DashEstruturaPaginasComponent},
];
