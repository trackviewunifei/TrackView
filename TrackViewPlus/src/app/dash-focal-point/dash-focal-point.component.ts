...
@Component({
  selector: 'app-dash-focal-point',
  templateUrl: './dash-focal-point.component.html',
  styleUrls: ['./dash-focal-point.component.css']
})
export class DashFocalPointComponent implements OnChanges {
